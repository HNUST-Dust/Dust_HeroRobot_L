...
void Chassis::OperationMode()
{
    switch (chassis_opreation_mode_)
    {
        ...
        {
            strcpy(ui_g_Ungroup_chassis_mode_flag->string, "spin   ");
        ...
        {
            strcpy(ui_g_Ungroup_chassis_mode_flag->string, "followh");
        ...
        {
            strcpy(ui_g_Ungroup_chassis_mode_flag->string, "followb");
